...
public class WinningBidResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new winningBidDTO, or with status {@code 400 (Bad Request)} if the winningBid has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("")
    public ResponseEntity<WinningBidDTO> createWinningBid(@RequestBody WinningBidDTO winningBidDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/winning-bids/" + winningBidDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, winningBidDTO.getId().toString()))
            .body(winningBidDTO);
    }
     ...
     * or with status {@code 500 (Internal Server Error)} if the winningBidDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    public ResponseEntity<WinningBidDTO> updateWinningBid(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, winningBidDTO.getId().toString()))
            .body(winningBidDTO);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated winningBidDTO,
     * or with status {@code 400 (Bad Request)} if the winningBidDTO is not valid,
     * or with status {@code 404 (Not Found)} if the winningBidDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the winningBidDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of winningBids in body.
     */
    @GetMapping("")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the winningBidDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
